...
draw_text(menu_x + 20, menu_y + 10, "Choose an interaction:");

// Display options
for (var i = 0; i < array_length(global.interaction_options); i++) {
    draw_set_color(c_white);
    ...
    draw_text(menu_x + 20, menu_y + 30 + (i * 20), global.interaction_options[i]);
}

// Draw cancel instruction
draw_set_color(c_white);
draw_text(menu_x + 20, menu_y + menu_height - 20, "[Esc] Cancel Interaction");
